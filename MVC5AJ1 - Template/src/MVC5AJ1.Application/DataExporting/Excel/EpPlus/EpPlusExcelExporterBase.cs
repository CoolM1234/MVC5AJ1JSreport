...
using MVC5AJ1.Dto;
using MVC5AJ1.Net.MimeTypes;
using OfficeOpenXml;

namespace MVC5AJ1.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : MVC5AJ1ServiceBase, ITransientDependency
    {
