...
using MVC5AJ1.Web.App.Startup;//SPA!
using MVC5AJ1.Web.Bundling;
using MVC5AJ1.Web.Navigation;
using MVC5AJ1.Web.Routing;
using MVC5AJ1.WebApi;
using MVC5AJ1.Web.App_Start.Filter;//NCW
...
namespace MVC5AJ1.Web
{
    ...
    [DependsOn(
        ...
        typeof(MVC5AJ1DataModule),
        typeof(MVC5AJ1ApplicationModule),
        typeof(MVC5AJ1WebApiModule),
    ...
    public class MVC5AJ1WebModule : AbpModule
    {
